...
var fs = require('fs')
var theta_deposit_verifier = require('./jobs/theta_deposit_verifier.js')
...
function main() {
  ...
  theta_deposit_verifier.Initialize(config, web3Node);

  // start job
  schedule.scheduleJob(config.exe_freq.theta_deposit.verifier, theta_deposit_verifier.Execute);
}
